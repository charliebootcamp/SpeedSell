      ...
      <div class="row">
        <div class="col-sm-3">
          <ul class="nav nav-pills nav-stacked">
            <li><a href="#requests/pending"><h4>Pending requests <span class="badge">{{AdminrequestsCtrl.pendingrequests.length}}</span></h4></a></li>
            <li class="active"><a href="#requests/accepted"><h4>Accepted requests <span class="badge">{{AdminrequestsCtrl.acceptedrequests.length}}</span></h4></a></li>
            <li><a href="#requests/denied"><h4>Denied requests <span class="badge">{{AdminrequestsCtrl.deniedrequests.length}}</span></h4></a></li>
          </ul>
        </div>
        <div class="col-sm-9">
          <div class="tab-content">
            <div id="acceptedrequests" class="tab-pane fade in active">
              <div class="container-fluid">
                <div class="row">
                  <div ng-if="AdminrequestsCtrl.acceptedrequests.length == 0"><h3>No requests.</h3></div>
                  <div class="col-sm-4"  ng-repeat="x in AdminrequestsCtrl.acceptedrequests">
                    <div class="card">
                      <a href="#lot/{{x.id}}">
