      ...
      <div class="row">
        <div class="col-sm-3">
          <ul class="nav nav-pills nav-stacked">
            ...
            <li class="active"><a href="#requests/denied"><h4>Denied requests <span class="badge">{{AdminrequestsCtrl.deniedrequests.length}}</span></h4></a></li>
          </ul>
        </div>
        <div class="col-sm-9">
          <div class="tab-content">
            <div id="deniedrequests" class="tab-pane fade in active">
              <div class="container-fluid">
                <div class="row">
                  <div ng-if="AdminrequestsCtrl.pendingrequests.length == 0"><h3>No requests.</h3></div>
                  <div class="col-sm-4"  ng-repeat="x in AdminrequestsCtrl.deniedrequests">
                    <div class="card">
                      <a href="#lot/{{x.id}}">
