<div class="container" id="myaccount" ng-controller="AccountController as ACtrl" data-ng-init="ACtrl.loadLots(4)">
  ...
  <div class="tab-content panel">
      ...
      <div class="row">
        <div class="col-sm-2">
          <ul class="nav nav-pills nav-stacked"  role="tablist">
            ...
            <li class="active"><a href="#myaccount/lots_archive">Archive</a></li>
                    ...
                    <div class="card">
                      <a href="#lot/{{lot.id}}">
                        ...
                        <div class="card-container">
                          ...
                          <div>Started: <span class="DateTime">{{lot.startDate | date:'yyyy-MM-dd HH:mm:ss'}}</span></div>
                          <div>Finished: <span class="DateTime">{{lot.startDate + lot.duration | date:'yyyy-MM-dd HH:mm:ss'}}</span></div>
                        </div>
                        <div class="panel-footer">
                        <div class="row">
                        <div class="col-xs-4">
                          <a title="Place this lot again." href="" ng-click="ACtrl.showModalPlaceAgain(lot.id)"><span class="glyphicon glyphicon-refresh footer-glyph footer-but-inside"></span></a>
                        </div>
                        <div class="col-xs-4">
                          <a title="Edit this lot." href="" ng-click="ACtrl.showModalEdit(lot)"><span class="glyphicon glyphicon-pencil footer-glyph footer-but-inside"></span></a>
                        </div>
    ...
    <div class="modal fade" id="placeAgain" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" id="CloseModal">&times;</button>
            <h4 class="modal-title">Place again:</h4>
          </div>
          <div class="modal-body">
            <form id="request-form" class="form-horizontal" action="#" method="post" role="form" style="display: block;">
              <div>
                <div class="form-group">
                  <label class="control-label col-sm-4" for="categoryparent">Duration (hours):</label>
                  <div class="col-sm-6">
                    <input class="form-control" type="text" id="duration"
                      ng-model="ACtrl.duration" placeholder="Enter duration" required only-digits
                      ng-blur="ACtrl.duration = ACtrl.checkNum(ACtrl.duration)">
                    </div>
                  </div>
                </div>
              </form>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-success"
                ng-click="ACtrl.placeAgain(ACtrl.duration)">Send request</button>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-success"
                              ng-click="ACtrl.sendEditedLot(selectedSubcategory.id)">Finish</button>
                              <button type="button" class="btn btn-default"
                                data-dismiss="modal">Cancel</button>
                              </div>
                            </div>
