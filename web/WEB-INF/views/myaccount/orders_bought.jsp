<div class="container" id="myaccount" ng-controller="AccountController as ACtrl" data-ng-init="ACtrl.loadOrders(6)">
      ...
      <div class="row">
        <div class="col-sm-2">
          <ul class="nav nav-pills nav-stacked">
            <li><a href="#myaccount/orders_active">Active</a></li>
            <li><a href="#myaccount/orders_wfpay">Wait for pay</a></li>
            <li class="active"><a href="#myaccount/orders_bought">Bought</a></li>
          </ul>
        </div>
        <div class="col-sm-10">
          <div class="tab-content">
            <div id="orders_bought" class="tab-pane active">
                    ...
                    <div class="card">
                      <a href="#lot/{{lot.id}}">
                        ...
                        <div class="card-container">
                          ...
                          <div>Your bid: <span class="Bid">{{lot.bestBid.amount}}</span>$</div>
                          <div>Seller: <a href="#/user_feedbacks/{{lot.owner.id}}">{{lot.owner.name}}</a></div>
                          <div>Bought: <span class="DateTime">{{lot.startDate + lot.duration | date:'yyyy-MM-dd HH:mm:ss'}}</span></div>
                        </div>
                        <div class="panel-footer">
                        <div class="row">
								<div class="col-xs-6">
                      				<a title="Contact with seller." href=""
                        				ng-click="ACtrl.sendQuestion(lot.owner.email, lot.name)">
                        				<span class="glyphicon glyphicon-envelope footer-glyph footer-but-inside"></span>
                      				</a>
								</div>
								<div class="col-xs-6">
                      				<a title="Send feedback." href="" ng-click="ACtrl.showModalFeedback(lot.id, lot.bestBid.bidder.id, lot.owner.id)">
