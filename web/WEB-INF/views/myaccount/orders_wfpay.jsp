<div class="container" id="myaccount" ng-controller="AccountController as ACtrl" data-ng-init="ACtrl.loadOrders(5)">
      ...
      <div class="row">
        <div class="col-sm-2">
          <ul class="nav nav-pills nav-stacked">
            ...
            <li class="active"><a href="#myaccount/orders_wfpay">Wait for pay</a></li>
            <li><a href="#myaccount/orders_bought">Bought</a></li>
          </ul>
        </div>
        <div class="col-sm-10">
          <div class="tab-content">
            <div id="orders_wfpay" class="tab-pane active">
